...
class Whiskey(db.Model):
    ...
    def __init__(self, name, brand, year, _type, user_token, id=''):
        self.id = self.set_id()
        self.name = name
        self.brand = brand
        self.year = year
    ...
    def __repr__(self):
        return f"The following bottle has been added to your collection: {self.name}"
...
class WhiskeySchema(ma.Schema):
    class Meta:
        fields = ['id', 'name', 'brand', 'year', '_type']
